...
export function SpecSelector({
	...
	return (
		<div ref={ref} className='relative'>
			<div
				className='w-full flex items-center h-12 bg-white/5 border border-white/10 rounded-2xl text-sm hover:bg-white/8 overflow-hidden'
			...
			>
				...
				<div className='flex items-center justify-end gap-1.5 px-5 h-full cursor-pointer border-l border-white/5 text-[#6B7280] hover:text-[#F2F2F2] flex-shrink-0'>
					{(selected || search) && (
