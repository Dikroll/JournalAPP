...
import { BrandLogo, GlowBackground } from "@/shared/ui";
	...
	return (
		...
		>
			...
			>
				<form
					onSubmit={submit}
					className="w-full min-h-[360px] flex flex-col gap-4 bg-glass backdrop-blur-3xl p-8 rounded-3xl border border-app-border justify-center"
