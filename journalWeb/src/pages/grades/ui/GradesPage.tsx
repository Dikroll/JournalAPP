...
import { lastValue, useDashboardCharts } from "@/entities/dashboard/hooks/useDashboardCharts"
...
import { GradesSubjectList } from "@/widgets/GradesList/ui/GradesSubjectList"
...
export function GradesPage() {
  ...
  useEffect(() => {
    if (selectedSpecId != null) loadSubject(selectedSpecId)
  }, [selectedSpecId])

  const selectedSubjectCache = selectedSpecId != null ? subjectCache[selectedSpecId] : null
  const sourceEntries =
    ...
    <div className="min-h-screen text-[#F2F2F2] pb-28">
      <div className="p-4 space-y-4">
        ...
        <SpecSelector
          ...
          onChange={(s) => setSelectedSpecId(s?.id ?? null)}
      ...
      <div className="px-4">
        ...
        {activeTab === "subjects" && <GradesSubjectList bySubject={bySubject} />}
      </div>
    </div>
  )
}