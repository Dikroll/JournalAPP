 ...
 * В списках с 20+ карточками каждое изменение store (фильтр, статус)
 * вызывало каскадный ре-рендер всех карточек.
 * memo + сравнение по hw.id и hw.status предотвращает лишние рендеры.
 */
