...
export function NextClassWidget() {
	...
	if (status !== "success" || today.length === 0) {
		return (
			<div
				className="rounded-3xl border border-app-border p-3.5 flex flex-col min-h-0 relative overflow-hidden"
				style={{
	...
	return (
		<div
			className="rounded-3xl border border-app-border p-3 flex flex-col min-h-0 relative overflow-hidden"
			style={{
				background: "var(--color-surface)",
				boxShadow: "var(--shadow-card)",
			}}
